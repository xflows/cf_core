...
def core_object_viewer(request,input_dict,output_dict,widget):
    import pprint
...
def core_display_string(request,input_dict,output_dict,widget):
    return render(request, 'visualizations/display_string.html',{'widget':widget,'input_dict':input_dict,'output_dict':output_dict})

def core_string_to_file(request,input_dict,output_dict,widget):
    from . import helpers
